...
abstract class Model
{
    ...
    public static function saleWithProduk(){
        $instance = new static();
        $instance->db->query('SELECT sale.id, sale.date, sale.jumlah, sale.size, produk.nama, sale.produk_id, produk.harga, produk.gambar FROM sale JOIN produk ON sale.produk_id = produk.id');
        return $instance->db->resultSet();
    }
